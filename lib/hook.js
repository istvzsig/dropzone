...
function useDropZone() {
  ...
  var handleDrop = function handleDrop(event) {
    var asyncCallback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Promise;
    event.preventDefault();
    setIsDragOver(false);
  ...
  var handleFiles = function handleFiles() {
    var files = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : FileList;
    var asyncCallback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Promise;
  ...
  var handleSaveFile = function handleSaveFile() {
    var file = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : File;
    var asyncCallback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Promise;
    ...
    reader.onload = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return asyncCallback(reader.result);
          case 2:
          case "end":
  ...
  (0, _react.useEffect)(function () {
    ...
    return function () {
      for (var _eventName in events) {
        document.removeEventListener(_eventName, events[_eventName]);
      }
    };
  }, []);
  return {
